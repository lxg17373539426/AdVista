...
<style>
:root{{--ink:#19352f;--deep:#123c35;--paper:#f4efe5;--paper-light:#fbf9f4;--line:#d9d4c8;--muted:#6d766e;--orange:#d45532;--amber:#a56b21;--red:#b53a35;--green:#32735e}}
...
h1{{max-width:850px;margin:0 0 20px;font-size:clamp(2rem,4vw,3.8rem);line-height:1.1;font-weight:750;letter-spacing:0}}.summary{{max-width:760px;margin:0;color:#526159;font-size:1.04rem}}.header-row{{display:flex;align-items:end;justify-content:space-between;gap:24px;margin-top:30px}}.status{{display:inline-flex;align-items:center;gap:7px;padding:5px 10px;border-radius:999px;font-size:12px;font-weight:700;white-space:nowrap}}.status::before{{content:"";width:6px;height:6px;border-radius:50%;background:currentColor}}.status.pass{{color:var(--green);background:#e3eee8}}.status.review{{color:var(--amber);background:#f5e8cf}}.status.fail{{color:var(--red);background:#f5dfdc}}
