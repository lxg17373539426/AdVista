...
.insight{{position:relative;margin:0 0 15px;padding:23px 25px 25px;background:var(--paper-light);border:1px solid var(--line);border-left:3px solid var(--green)}}.insight.review{{border-left-color:var(--amber)}}.insight.fail{{border-left-color:var(--red)}}.insight-head{{display:flex;align-items:center;justify-content:space-between;gap:14px}}.insight-id{{color:var(--muted);font:600 11px ui-monospace,monospace;letter-spacing:.04em}}h3{{max-width:850px;margin:14px 0 8px;font-size:20px;line-height:1.45}}.reasoning{{max-width:850px;margin:0;color:#5f6368}}.meta{{display:flex;flex-wrap:wrap;gap:10px 18px;margin-top:16px;color:var(--muted);font-size:12px}}.meta span+span{{position:relative}}.meta span+span::before{{content:"/";position:absolute;left:-11px;color:#c8c9ca}}
.subhead{{margin-top:22px;color:var(--muted);font-size:10px;font-weight:750;letter-spacing:.12em}}.evidence-grid{{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:10px;margin-top:10px}}.evidence-card{{overflow:hidden;border:1px solid var(--line);background:#f7f4ed}}.evidence-card img{{display:block;width:100%;aspect-ratio:16/10;object-fit:cover;background:#e5e1d7}}.evidence-copy{{padding:11px 12px}}.evidence-label{{display:flex;justify-content:space-between;gap:8px}}code{{font-family:ui-monospace,monospace;font-size:.8em}}.time{{color:var(--orange);font:650 .76em ui-monospace,monospace}}.evidence-card p{{margin:7px 0 8px;line-height:1.5}}small{{color:var(--muted);font-size:11px}}.empty-state{{margin-top:9px;padding:12px;background:#f1ede4;color:var(--muted);font-size:12px}}.findings{{margin-top:18px;padding-top:14px;border-top:1px dashed var(--line)}}.findings .subhead{{margin:0}}.findings ul{{margin:8px 0 0;padding-left:20px;color:var(--muted);font-size:12px}}.findings .warning{{color:var(--amber)}}.findings .error{{color:var(--red)}}
 .unknowns{{margin-top:56px;padding:22px 25px;background:var(--soft);border:1px solid var(--line);border-left:3px solid var(--orange);scroll-margin-top:18px}}.unknowns ul{{display:grid;gap:8px;margin:0;padding:0;list-style:none;color:#5f6368;font-size:13px}}.unknowns li{{display:flex;gap:10px}}.unknown-mark{{display:inline-grid;place-items:center;flex:none;width:18px;height:18px;border:1px solid #e8c3ad;border-radius:50%;background:#fff;color:#b65f3e;font:750 11px/1 ui-monospace,monospace}}.unknowns.empty p{{margin:0;color:var(--muted);font-size:13px}}footer{{margin-top:56px;padding-top:18px;border-top:1px solid var(--line);color:var(--muted);font-size:11px}}
@media(max-width:780px){{.layout{{display:block}}.rail{{position:relative;height:auto;padding:20px 18px 16px;border-right:0;border-bottom:1px solid var(--line)}}.rail-title{{margin:22px 0 8px}}nav{{display:flex;overflow:auto;gap:8px;padding-bottom:3px}}nav a{{flex:none;padding:6px 8px;border:1px solid var(--line)}}nav a:hover{{border-color:var(--orange)}}.rail-foot{{display:none}}main{{padding:30px 18px 58px}}h1{{font-size:34px}}.header-row{{display:block;margin-top:25px}}.scoreboard{{margin-top:18px;grid-template-columns:repeat(2,1fr);max-width:none}}.score:nth-child(2){{border-right:0}}.score:first-child{{grid-column:span 2;border-right:0;border-bottom:1px solid var(--line)}}.dimension{{padding-top:40px}}.insight{{padding:19px 17px 21px}}h3{{font-size:18px}}}}
